  ...
  function handleChange(event) {
    ...
    setFullName(prevValue => {              // React comes with the prevValue functionality (the previous state for the object in question)
      if (inputName === "fName") {
        return {
          fName: newValue,                  
          lName: prevValue.lName            // have to specify to maintain the previous value for the field not being changed, or else it'll be reset to the initial state of empty
                }
